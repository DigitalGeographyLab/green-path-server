...
def test_can_remove_linking_edges_after_routing(
    log, 
    ...
    od_nodes = routing.find_or_create_od_nodes(log, graph_handler, routing_conf, od_settings)
    ...
    routing.delete_added_graph_features(log, graph_handler, od_nodes)
...
def test_path_props_when_routing_with_created_OD(
    ...
    assert props['bike_time_cost'] == 291.92
    assert props['bike_safety_cost'] == 291.92
