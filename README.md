...
Currently implemented features include calculation of unpolluted and quiet paths for walking or cycling (separately) with respect to real-time air quality and typical (day-evening-night time) noise levels from road, rail and air traffic. The exposure-based routing method (and application) is based on [an MSc thesis](https://github.com/hellej/quiet-paths-msc). 
